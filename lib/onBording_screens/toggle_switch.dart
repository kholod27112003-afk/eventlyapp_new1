          ...
          child: Column(
            ...
            children: [
              ...
              SizedBox(
                child: AnimatedToggleSwitch<bool>.dual(
                  ...
                  textBuilder: (value) => value
                      ? const Center(child: Text('Oh nooooo...'))
                ...
                child: IconTheme.merge(
                  ...
                  child: AnimatedToggleSwitch<bool>.dual(
                    ...
                    textBuilder: (value) => value
                        ...
                        : const Center(child: Text('Unactive')),
                  ),
                ),
              ),
              const Padding(
              ...
              const Padding(
                padding: EdgeInsets.all(8.0),
                child: Text(
                  'You can make switch with CustomAnimatedToggleSwitch:',
                ),
              ),
